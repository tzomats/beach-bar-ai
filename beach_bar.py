...
def chat():
    ...
    system_instruction = (
        ...
        "Απάντησε σύντομα. ΟΤΑΝ ο πελάτης παραγγείλει, γράψε ΟΠΩΣΔΗΠΟΤΕ τη λέξη ORDER_JSON "
        "και μετά ένα JSON με αυτή ακριβώς τη δομή: "
        "{\"umbrella_number\": \"" + umbrella_fixed + "\", \"products_list\": [{\"name\": \"όνομα προϊόντος\", \"qty\": 1}]}"
    )
