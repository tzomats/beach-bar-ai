...
def chat():
    ...
    system_instruction = (
        ...
        "Απάντησε σύντομα και φιλικά. "
        "ΟΤΑΝ ο πελάτης παραγγείλει, πρέπει ΟΠΩΣΔΗΠΟΤΕ να γράψεις τη λέξη ORDER_JSON "
        "ακριβώς μετά την απάντησή σου και μετά να βάλεις το JSON. "
        "Παράδειγμα: 'Βεβαίως! ORDER_JSON {\"umbrella_number\":\"7\", ...}'"
    )
